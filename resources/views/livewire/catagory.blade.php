...
<body>
	...
	<section id="foodies" style="margin: 80px;"> <!--MARGIN HERE CAN/SHOULD BE BETTER -->
		<div class="isotope-container row">
			...
			<div class="card item col-md-4 col-lg-3 my-4 position-absolute">
				<a href="/selectVarient?product_id={{ $product->product_id }}&selCat={{ $_GET['selCat'] }}"><img src="home/images/item9.jpg" class="img-fluid rounded-4" alt="image"></a>
